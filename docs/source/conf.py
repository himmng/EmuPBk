# -*- coding: utf-8 -*-
#
# EmuPBk documentation build configuration file
#
...
import EmuPBk
from EmuPBk import __version__
...
project = u'EmuPBk'
copyright = u'2020, Himanshu Tiwari'
...
texinfo_documents = [
  ('index', 'EmuPBk', u'EmuPBk Documentation',
   u'Himanshu Tiwari', 'EmuPBk', 'One line description of project.',
   'Miscellaneous'),
]
